...
import { Edit2, Check, X, Trash2, FastForward, Image as ImageIcon, RefreshCw, Hammer, Download, Wand2 } from 'lucide-react';
...
const MessageItem = memo(({ 
    ...
    return (
        <div className={`message-wrapper ${msg.role} ${isImmersionMode ? 'immersion' : ''}`}>
