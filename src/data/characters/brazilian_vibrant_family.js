...
export const brazilian_vibrant_family = {
  ...
  wardrobe: [
    ...
    { id: 'bikini', name: 'Matching Rio Beach Bikinis', avatar: '/gallery/wardrobe/brazilian_vibrant_family_3.png', minScore: 40 },
    { id: 'sheer', name: 'Matching Sheer Club Sets', avatar: '/gallery/wardrobe/brazilian_vibrant_family_4.png', minScore: 60 }
  ],
