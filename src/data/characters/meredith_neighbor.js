...
export const meredith_neighbor = {
  ...
  wardrobe: [
    ...
    { id: 'braless', name: 'Braless Tank Top', avatar: '/gallery/wardrobe/meredith_neighbor_3.png', minScore: 40 },
    { id: 'lingerie', name: 'Silk Robe Only', avatar: '/gallery/wardrobe/meredith_neighbor_4.png', minScore: 60 }
  ],
