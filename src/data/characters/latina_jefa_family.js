...
export const latina_jefa_family = {
  ...
  wardrobe: [
    ...
    { id: 'velvet', name: 'Matching Velvet Robes', avatar: '/gallery/wardrobe/latina_jefa_family_3.png', minScore: 40 },
    { id: 'wet_shower', name: 'Matching Post-Shower Look', avatar: '/gallery/wardrobe/latina_jefa_family_4.png', minScore: 60 }
  ],
