...
export const amber_yoga_instructor = {
  ...
  wardrobe: [
    ...
    { id: 'bra_top', name: 'Sporty Bra Set', avatar: '/gallery/wardrobe/amber_yoga_instructor_3.png', minScore: 40 },
    { id: 'bare', name: 'Post-Workout Relaxed', avatar: '/gallery/wardrobe/amber_yoga_instructor_4.png', minScore: 60 }
  ],
