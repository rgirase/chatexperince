...
$prompt = "High-end luxury velvet club interior, a large group of 10 beautiful sophisticated diverse women models, elegant evening wear, silk sarees and cocktail dresses, mysterious smiles, masterpiece, 8k uhd, photorealistic, glamorous atmosphere, wide shot"
...
try {
    ...
    Write-Host "Failed to connect to ComfyUI at $COMFY_URL. Error: $($_.Exception.Message)" -ForegroundColor Red
}
